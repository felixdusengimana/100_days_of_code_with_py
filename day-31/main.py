...
def next_card():
    ...
    canvas.itemconfig(card_title, text="Fresh", fill="black")
...
chek_image = PhotoImage(file="images/right.png")
known_button = Button(image=chek_image, highlightthickness=0, command=is_known)
